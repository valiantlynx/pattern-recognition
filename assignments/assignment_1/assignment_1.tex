...
\usepackage{titlesec}
\usepackage{graphicx} 
\usepackage{float} % REQUIRED to use [H] for fixing image positions
...
\begin{figure}[H] % [H] forces the image to stay HERE
    \centering
    \includegraphics[width=0.7\textwidth]{"Task 1: Synthetic Data - Decision Boundary.png"}
    \caption{Decision Boundary for Synthetic Binary Classification}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{"Task 1: Synthetic Data - Confusion Matrix.png"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{"Task 3A: Iris (2 Features) - Descision boundary.png"}
    \caption{Iris Decision Boundary (Sepal Features)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{"Task 3B: Iris (Full Features).png"}
