...
This assignment focuses on implementing a Gaussian Naïve Bayes (GNB) classifier from scratch. The main goal was the probabilistic foundations of the algorithm, specifically utilizing Bayes' Theorem and the assumption of independence among features. I implemented the algorithm in Python, tested it on a synthetic binary dataset, and extended it for multi-class classification using the Iris dataset.
